...
import static com.disparta.CommonUtilities.DISPLAY_MESSAGE_ACTION;
...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNumberView = (EditText)findViewById(R.id.phoneNumber);
        mEmailAdView = (EditText)findViewById(R.id.emailAddress);
    ...
    public void register() {
       ...
       // registerReceiver(mHandleMessageReceiver, new IntentFilter(DISPLAY_MESSAGE_ACTION));
        ...
        String emailA = mEmailAdView.getText().toString();
        ...
        if (TextUtils.isEmpty(emailA)) {
            mEmailAdView.setError(getString(R.string.error_field_required));
            focusView = mEmailAdView;
            cancel = true;
        ...
        if (cancel) {
            ...
            client.post("http://disparta.com/android/app/register.php", params, new AsyncHttpResponseHandler() {
